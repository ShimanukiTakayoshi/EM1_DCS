Public Class frmHist1

    Private Sub frmHist1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        HistInit1()
        HistMain1()
    End Sub

    Public Sub HistInit1()
        Me.Width = 430
        Me.Height = 335
        Me.FormBorderStyle = FormBorderStyle.FixedSingle
        picHist1.Width = 390
        picHist1.Height = 240
        If frmMain.HistInitFlag1 = False Then
            With cbxCh1
                .Items.Add("Total")
                .Items.Add("Ch-1")
                .Items.Add("Ch-2")
    ...
    Private Sub cbxItem1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxItem1.SelectedIndexChanged
        If frmMain.StackCounter > 0 Then
            HistMain1()
        End If
    End Sub

    Private Sub btnCloseHist1_Click(sender As Object, e As EventArgs) Handles btnCloseHist1.Click
        Me.Hide()
    End Sub

    Public Sub picHist1_Paint(sender As Object, e As PaintEventArgs) Handles picHist1.Paint
        HistMain1()
    End Sub

    Private Sub timHist1_Tick_1(sender As Object, e As EventArgs) Handles timHist1.Tick
        HistMain1()
    End Sub
